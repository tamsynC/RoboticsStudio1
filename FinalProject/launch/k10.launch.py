...
def generate_launch_description():
    ...
    K10_AUDIO_DETECT_NODE = Node(
        package="PACKAGE_NAME",
        executable="EXECUTABLE_NAME",
        name="K10_AUDIO_DETECT_NODE",
        output="screen"
    )
    
    K10_IMAGE_DETECT_NODE = Node(
        package="PACKAGE_NAME",
        executable="EXECUTABLE_NAME",
        name="K10_IMAGE_DETECT_NODE",
        output="screen"
    )
    
    K10_GAS_DETECT_NODE = Node(
        package="PACKAGE_NAME",
        executable="EXECUTABLE_NAME",
        name="K10_GAS_DETECT_NODE",
        output="screen"
    )
    ...
    ld.add_action(K10_CORE_NODE)
    ld.add_action(K10_AUDIO_DETECT_NODE)
    ld.add_action(K10_IMAGE_DETECT_NODE)
    ld.add_action(K10_GAS_DETECT_NODE)
